...
var initialData = {
    ...
    users: {
        "1": {
            ...
            description:
                "Welcome to Wemeet! If there are any questions, ask me!",
            friends: [
            ...
            password:
                "$2a$10$1BmmDhIqBX7zdb/VlysJzeabojvhOc4yez/LCwwetMmTkzWlMGzMa",
            online: false
        },
        "2": {
...
function reset(cb) {
    mongoClient.connect(
        "mongodb://localhost:27017/wemeet, localhost:27018/wemeet2",
        {
