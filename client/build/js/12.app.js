...
var Chat = function (_React$Component) {
    ...
    _createClass(Chat, [{
        ...
        value: function componentDidMount() {
            ...
            _utils.socket.on('online', function (data) {
            ...
            _utils.socket.on('chat', function (data) {
        ...
        value: function componentWillUnmount() {
            _utils.socket.removeAllListeners("chat");
            _utils.socket.removeAllListeners('online');
        }
    }, {
