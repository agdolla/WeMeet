    ...
    return (
      ...
      >
        ...
        <DialogContent>
          <div
            className={
              "alert alert-danger " + hideElement(!this.state.failedLogin)
            }
            role="alert"
          >
            <strong>Invalid email address or password.</strong>
            <br />
            Please try a different email address or password, and try logging in
            again.
          </div>
          <FormControl style={{ width: "100%", marginBottom: "20px" }}>
            <InputLabel style={{ color: "#607D8B" }} htmlFor="signInEmail">
              Email
            </InputLabel>
            <Input
              id="signInEmail"
          ...
          <FormControl style={{ width: "100%" }}>
            <InputLabel style={{ color: "#607D8B" }} htmlFor="signInPass">
              Password
            </InputLabel>
            <Input
              id="signInPass"
