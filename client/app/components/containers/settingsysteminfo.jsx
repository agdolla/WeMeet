...
export default class SettingSystemInfo extends React.Component {
    ...
    handleChangePass() {
        ...
        if (
            ...
            changePassword(this.state.userData._id, data).then(response => {
    ...
    handleFile(e) {
        ...
        if (file.size > 1100000 || !file.type.match("image.*")) {
            let msg =
                file.size > 1100000
                    ? "File should be less than 1.1 MB"
    ...
    handleAvatarChange(e) {
        ...
        if (this.state.img !== null) {
            ChangeAvatar(this.state.userData._id, this.state.img).then(
                response => {
