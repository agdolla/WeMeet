...
export default class ActivityFeed extends React.Component {
    ...
    handleLoad(init) {
        ...
        var date =
            init || this.state.contents.length === 0
                ? new Date().getTime()
                : this.state.contents[this.state.contents.length - 1].postDate;
        getAllActivities(date).then(response => {
            ...
            var newActivities = (init ? [] : this.state.contents).concat(
                activities
            );
            this.setState(
                {
            ...
            <div id="activityFeed">
                ...
                {!this.state.loading && this.state.contents.length === 0 ? (
                    <div className="alert alert-info" role="alert">
                        No one has posted any activities yet. Post your first
                        activity
