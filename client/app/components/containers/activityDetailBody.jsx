...
export default class ActivityDetailBody extends React.Component {
    ...
    handleLikeClick(e) {
        ...
        if (e.button === 0) {
            ...
            if (
                !didUserLike(
                    this.state.activity.likeCounter,
                    this.props.currentUser
                )
            ) {
                likeActivity(
                    this.state.activity._id,
                    this.props.currentUser
                ).then(response => {
    ...
    getData() {
        getActivityDetail(this.props.id).then(response => {
    ...
    checkJoined() {
        ...
        return (
            this.state.activity.participants.filter(user => {
                return user._id == this.props.currentUser;
            }).length > 0
        );
    }
    ...
    checkFriendsOfUser(friendId) {
        return (
            this.props.currentUser === friendId ||
    ...
    loadComments(justPosted) {
        ...
        getActivityItemCommments(this.props.id, date).then(response => {
            let load = response.data.length > 0;
            let activityComments = justPosted
                ? response.data
    ...
    handleInvite(value) {
        ...
        if (newFriendList.indexOf(value) == -1) newFriendList.push(value);
    ...
    render() {
        ...
        return (
            <div className="activityDetail">
                                ...
                                return (
                                    <ListItem key={i}>
                                        ...
                                        <ListItemSecondaryAction>
                                            ...
                                            this.state.activity.participants.filter(
                                                participant => {
                                                    return (
                                                        participant._id ===
                                                        friend._id
                                                ...
                                                <Checkbox
                                                    ...
                                                    checked={
                                                        this.state.invitedFriendList.indexOf(
                                                            friend._id
                                                        ) !== -1
                                                    }
                                                />
                    ...
                    <DialogContent style={{ width: "600px" }}>
                        <List>
                            ...
                            this.state.activity.participants.length === 0
                                ...
                                : this.state.activity.participants.map(
                                      (p, i) => {
                                          var rightButton;
                ...
                <div
                    className="adbackground"
                    style={{
                        backgroundImage: "url(" + this.state.activity.img + ")"
                    }}
                />
                        ...
                        <div className="col-lg-10 col-md-12 col-sm-12 col-xs-12 col-lg-offset-1">
                            <div className="panel panel-default body-title">
                                <div className="panel-heading">
                                    ...
                                    <div className="row">
                                        <div
                                            className="col-md-12 col-sm-12 col-xs-12 remain-places"
                                            style={{
                                                paddingTop: "25px",
                                                textAlign: "center"
                                            }}
                                    ...
                                    <div className="row">
                                        <div
                                            className="col-md-12 col-sm-12 col-xs-12 body-title-icon"
                ...
                <ActivityCommentThread
                    ...
                    onPost={comment => this.handlePostComment(comment)}
                    onLoadComments={() => this.loadComments(false)}
