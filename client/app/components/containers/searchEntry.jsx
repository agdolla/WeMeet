    ...
    render() {
        return (
            <div>
                ...
                >
                    {this.state.searchDataResult.users === undefined
                        ? []
                        : this.state.searchDataResult.users.map((user, i) => {
                              var rightButton;
                              ...
                              return (
                                  <ListItem key={i} style={{ padding: "20px" }}>
                ...
                {this.state.searchDataResult.activities === undefined
                    ? []
                    : this.state.searchDataResult.activities.map(
                          (activity, i) => {
                              return (
                ...
                {this.state.searchDataResult.posts === undefined
                    ? []
                    : this.state.searchDataResult.posts.map((post, i) => {
                          return (
                              <PostFeedItem
                                  key={i}
                                  data={post}
