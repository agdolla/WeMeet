    ...
    getMessages(initialLoad) {
        let time =
            this.state.msgs.length > 0
                ? this.state.msgs[0].postDate
                : new Date().getTime();
        getActivityMessages(this.props.id, time).then(messages => {
            ...
            <div className="panel panel-default">
                <div className="panel-heading">
                    <div className="container-fluid">
                        <h4 style={{ color: "grey" }}>
                            Chat ({this.state.numberOfUsers})
                        </h4>
                    </div>
                </div>
                <div
                    className="panel-body"
                    ref="activityChatWindow"
                    ...
                    <div className="row">
                        <div className="col-md-10 col-xs-10 col-sm-10">
                            <textarea
                                ...
                                onKeyUp={e => this.handleSendMsg(e)}
                            />
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-2 send">
                            <button
                                ...
                                name="button"
                                onClick={e => this.handleSendMsg(e)}
                            >
                                Send
                            </button>
                        </div>
